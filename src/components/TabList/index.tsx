...
export default function SimpleTabs(props: any) {
  ...
  const searchComponent = (title: any) => {
    ...
    <Alert severity="warning"  style={{marginBottom:20}}>Exibindo apenas benefícios por tipo "{title}". <a data-v-fae5bece="" href="https://www.martinsatacado.com.br/beneficios-martins"  className="alert-link" target="_top" >Clique aqui</a> para exibir todos os benefícios.</Alert></div>)
  }
  return (
    ...
    style: {
      display: 'none'
          ...
          <Tab component={() => (
            <Button style={{minWidth: 180}} onClick={() => setValue(0)}>
...
{value == 0 ?  
          ...
          <Tab component={() => (
            <Button style={{minWidth: 180}} onClick={() => setValue(1)}>
              {value == 1 ?  
          ...
          <Tab component={() => (
            <Button style={{minWidth: 180}} onClick={() => setValue(2)}>
              {value == 2 ?  
          ...
          <Tab component={() => (
            <Button style={{minWidth: 180}} onClick={() => setValue(3)}>
              {value == 3 ?  
